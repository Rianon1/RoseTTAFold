...
def get_args(params):
    ...
    parser.add_argument('--orient', dest='use_orient', action='store_false', help='use orientations')
    parser.add_argument('--no-orient', dest='use_orient', action='store_true')
    parser.add_argument('--fastrelax', dest='fastrelax', action='store_false', help='perform FastRelax')
    parser.add_argument('--no-fastrelax', dest='fastrelax', action='store_true')
